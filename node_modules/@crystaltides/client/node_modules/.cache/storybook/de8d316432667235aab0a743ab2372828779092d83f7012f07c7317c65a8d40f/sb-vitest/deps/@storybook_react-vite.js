...
import {
  ...
  useEffect,
  useRef
} from "./chunk-PXHY33DN.js";
import "./chunk-ZSONLZET.js";
import "./chunk-WHGPS52J.js";
import {
  logger,
  scope
} from "./chunk-KIBCYWUY.js";
import "./chunk-7EW4QHOS.js";
import {
  require_react
} from "./chunk-R6ALPGB6.js";
import {
  __toESM
...
var Wrapper = (FRAMEWORK_OPTIONS == null ? void 0 : FRAMEWORK_OPTIONS.strictMode) ? import_react3.StrictMode : import_react3.Fragment;
var actQueue = [];
var isActing = false;
...
async function renderToCanvas({
  ...
  let { renderElement, unmountElement } = await import("./react-18-ONBSJS62.js"), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react3.default.createElement(Story, { ...storyContext }) : import_react3.default.createElement(ErrorBoundary, { key: storyContext.id, showMain, showException }, import_react3.default.createElement(Story, { ...storyContext })), element = Wrapper ? import_react3.default.createElement(Wrapper, null, content) : content;
...
var decorators = [
  (story, context) => {
    var _a2, _b;
    if (!((_b = (_a2 = context.parameters) == null ? void 0 : _a2.react) == null ? void 0 : _b.rsc))
      return story();
  ...
  (story, context) => {
    var _a2, _b;
    if (((_a2 = context.tags) == null ? void 0 : _a2.includes("test-fn")) && !((_b = scope.FEATURES) == null ? void 0 : _b.experimentalTestSyntax))
      throw new Error(
...
var _a;
var decorators2 = "FEATURES" in globalThis && ((_a = globalThis == null ? void 0 : globalThis.FEATURES) == null ? void 0 : _a.experimentalCodeExamples) ? [] : [jsxDecorator];
var parameters3 = {
  docs: {
    story: { inline: true }
  }
