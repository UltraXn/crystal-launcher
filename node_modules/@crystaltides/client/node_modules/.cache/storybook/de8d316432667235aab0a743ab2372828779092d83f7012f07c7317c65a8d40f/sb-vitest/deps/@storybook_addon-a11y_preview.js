...
var run = async (input = DEFAULT_PARAMETERS, storyId) => {
  var _a;
  let axe = ((_a = await import("./axe-R5CSAPGK.js")) == null ? void 0 : _a.default) || globalThis.axe, { config = {}, options = {} } = input;
  if (input.element)
    throw new ElementA11yParameterError();
  let context = {
    include: document2 == null ? void 0 : document2.body,
  ...
  let configWithDefault = {
    ...config,
    rules: [...DISABLED_RULES.map((id) => ({ id, enabled: false })), ...(config == null ? void 0 : config.rules) ?? []]
  };
      ...
      if (result) {
        ...
        if (reporting.addReport({
          ...
          if (!vitestMatchersExtended) {
            let { toHaveNoViolations } = await import("./matchers-DMFSMG2O-H2RIZ7UC.js");
