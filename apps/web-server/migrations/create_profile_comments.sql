...
CREATE TABLE IF NOT EXISTS public.profile_comments (
    ...
    profile_id UUID REFERENCES public.profiles(id) ON DELETE CASCADE, -- Owner of the profile
    author_id UUID REFERENCES public.profiles(id) ON DELETE CASCADE,  -- Author of the comment
