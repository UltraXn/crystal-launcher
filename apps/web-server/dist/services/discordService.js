 ...
 */
export const sendAnnouncement = async (webhookUrl, payload) => {
    if (!webhookUrl) {
 ...
 */
export const notifyNewThread = async (thread) => {
    const payload = {
        embeds: [{
 ...
 */
export const notifyMinecraftEvent = async (event, player, details) => {
    const payload = {
        embeds: [{
