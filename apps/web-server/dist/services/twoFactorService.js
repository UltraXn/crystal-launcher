...
export const updateUser2FARecord = async (userId, secret, enabled) => {
...
export const signAdminToken = (userId, role) => {
    return jwt.sign({ sub: userId, role, verified: true }, ADMIN_JWT_SECRET, { expiresIn: '1h' });
};
