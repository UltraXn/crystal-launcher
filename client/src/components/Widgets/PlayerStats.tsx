            ...
            <div className="stats-grid">
                ...
                <StatItem 
                    ...
                    value={(() => {
                        ...
                        const imgStyle: React.CSSProperties = { maxWidth: '100%', height: 'auto', objectFit: 'contain', imageRendering: 'pixelated' as any };
                ...
                />
                 <StatItem 
                    icon={<img src="/images/killucoin.png" alt="Coin" style={{width:'32px', height:'32px', objectFit:'contain', imageRendering: 'pixelated' as any }} />} 
